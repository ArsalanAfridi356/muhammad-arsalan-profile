...
import { ArrowDownRight, ArrowUpRight, CheckCircle2, Cog, Cpu, ExternalLink, Factory, Gauge, GitBranch, Code2, Mail, Menu, MoveRight, Network, ScanLine, Settings2, ShieldCheck, X, Zap } from 'lucide-react';
  ...
  return <main>
    <header className="nav shell">
      ...
      <nav className={menu ? 'nav-links open' : 'nav-links'}>
        ...
        <a className="nav-github" href={github} target="_blank" rel="noreferrer"><Code2 size={13} /> GITHUB</a>
      </nav>
    ...
    <section id="top" className="hero shell section-grid">
      <div className="hero-copy">
        ...
        <div className="actions"><a className="btn dark" href={linkedin} target="_blank" rel="noreferrer">LinkedIn <ExternalLink size={15} /></a><a className="btn ghost" href={github} target="_blank" rel="noreferrer">GitHub <Code2 size={15} /></a><a className="btn light" href={email}>Start a conversation <ArrowUpRight size={15} /></a></div>
      </div>
      <div className="hero-visual"><div className="stamp"><b>FIELD<br />RECORD</b><small>VOL. 01</small></div><MachineDiagram /><div className="hero-aside"><div><small>BASED IN</small><strong>Wernigerode, Germany</strong></div><div><small>FOCUS</small><strong>Maintenance<br />Reliability<br />Process improvement</strong></div></div></div>
